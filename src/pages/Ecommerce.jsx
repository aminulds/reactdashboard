...
import { earningData, SparklineAreaData, ecomPieChartData } from '../data/customData';
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$25,256.85</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className=' border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$89,535</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>$45,535</span>
                </p>
